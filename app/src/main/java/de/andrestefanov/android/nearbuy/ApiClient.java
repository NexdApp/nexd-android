...
import de.andrestefanov.android.nearbuy.auth.HttpBasicAuth;
import de.andrestefanov.android.nearbuy.auth.HttpBearerAuth;
import de.andrestefanov.android.nearbuy.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://nexd-api-alb-1107636132.eu-central-1.elb.amazonaws.com/";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
